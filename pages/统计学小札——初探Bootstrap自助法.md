- 英文Bootstrap中文是“靴带”的意思，出自“pull oneself up by one′s bootstrap“（用自己靴的带子把自己拉上去），比较普遍的意译为“自助法”。Bootstrap方法最初由美国斯坦福大学统计学教授Efron在1977年提出。作为一种非参数样本统计方法，Bootstrap方法为解决小规模子样试验评估问题提供了很好的思路。
